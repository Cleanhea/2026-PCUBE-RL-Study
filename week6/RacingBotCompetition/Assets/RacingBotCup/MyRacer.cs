...
public class MyRacer : RacerAgent
{
    ...
    MyRacerCollisionSensor m_CollisionSensor;
    ...
    bool EnsureEpisode()
    {
        ...
        if (m_TrainingEpisode)
        {
            ...
            m_CollisionSensor = Car.Body.GetComponent<MyRacerCollisionSensor>();
            if (m_CollisionSensor == null)
                m_CollisionSensor = Car.Body.gameObject.AddComponent<MyRacerCollisionSensor>();
...
[AddComponentMenu("")]
public sealed class MyRacerCollisionSensor : MonoBehaviour
{
    [NonSerialized] public MyRacer Owner;
